<body>
  ...
  <li><a href="bible-list.php">my commentary</a>
</li>
    <li><a href="church1.php">Church</a>
    
    <ul>
    <li><a href="ihopkc1.htm">IHOPKC</a> 
...
<li><a href="line1.html">freemind</a></li>
    ...
    <li><a href="decide3.php">Critical decision making theory</a></li>
       ...
       <li> <a href="#" class="nav-active">Bible</a>
        ...
        <li><a href="#">Worship</a>
        <ul>
        <li><a href="psalmody1.php">Exclusive Psalmody</a></li>
        ...
        <li><a href="biblemenu.php">Bible display</a></li>
          ...
          <ul>
            <li><a href="comment1.php">commentaries</a></li>
...
<ul>
  ...
  <li><a href="rapture1.php">pre trib rapture?</a></li>
      ...
      <ul>
        <li><a href="turntable1.php">On my turntable</a>
...
<li><a href="#">Deliverance</a></li>
    ...
    <ul> 
      ...
      <li><a href="theodicy2.php">Theodicy</a></li>
      <li><a href="apologetics1.php">Christian Apologetics</a></li>
...
<li><a href="https://solarimpulse.com/solutions-explorer/white-hydrogen">White Hydrogen</a></li>
...
<li><a href="#">html css</a></li>
    ...
    <ul>
      ...
      <li><a href="#">international law testing</a></li>
      <li><a href="titantxt1.php">Oceangate disaster</a></li>
</ul>
</li>
