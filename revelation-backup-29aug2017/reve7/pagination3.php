...
$query = "SELECT * FROM seiss  order by book DESC LIMIT $start_from, $record_per_page";
 ...
 <body>
  ...
  <div class="container">
   ...
   <div class="table-responsive">
    ...
    <br />
    <?php
    $page_query = "SELECT * FROM seiss ORDER BY book DESC";
    ...
    if($page > 1)
    {
     echo "<a href='pagination3.php?page=1'>First</a>";
     echo "<a href='pagination3.php?page=".($page - 1)."'><<</a>";
    }
    ...
    {
     echo "<a href='pagination3.php?page=".($page + 1)."'>>></a>";
     echo "<a href='pagination3.php?page=".$total_pages."'>Last</a>";
    }
