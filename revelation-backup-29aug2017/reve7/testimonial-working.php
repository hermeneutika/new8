...
$sql = "SELECT $field1, $field2, $field3 FROM $table  ORDER BY $field1 DESC $limit";
$query = mysqli_query($db_conx, $sql);
...
while($row = mysqli_fetch_array($query, MYSQLI_ASSOC)){
	...
	$list .= '<p><a href="testimonial.php?id='.$id.'">'.$firstname.' '.$lastname.' Testimonial</a> - Click the link to view this testimonial<br>Written '.'</p>';
}
